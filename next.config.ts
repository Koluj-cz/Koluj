...
const nextConfig: NextConfig = {
  async redirects() {
    return [
      ...
      { source: "/dashboard/bookings", destination: "/dashboard/bookings", permanent: true },
      { source: "/dashboard/bookings/:path*", destination: "/dashboard/bookings/:path*", permanent: true },
    ];
  },
};
