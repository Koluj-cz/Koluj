...
export default function OfferSearchFilters({
  ...
  const selectClass =
    "min-h-[58px] w-full rounded-2xl border border-[var(--koluj-border)] bg-white px-4 font-bold text-[var(--koluj-text)] outline-none transition focus:border-[var(--koluj-green)] disabled:cursor-not-allowed disabled:opacity-55";
