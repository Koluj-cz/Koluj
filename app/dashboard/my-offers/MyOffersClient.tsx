...
export type MyOffer = OfferCardOffer & {
  is_active: boolean;
...
export default function MyOffersClient({
  ...
  const [items, setItems] = useState<MyOffer[]>(initialOffers);
  ...
  async function loadOffers() {
    ...
    setItems((result?.offers || []) as MyOffer[]);
  }


  async function toggleVisibility(item: MyOffer) {
  ...
  async function archiveOffer(item: MyOffer) {
